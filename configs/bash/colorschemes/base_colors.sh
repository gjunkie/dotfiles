# Adds the color coding to Terminal
c_cyan=`tput setaf 6`
c_red=`tput setaf 1`
...
EWhite="\033[0;37m"         # White

# Bold
EBBlack="\033[0;30m"  			# Black
EBRed="\033[1;31m"    			# Red
EBGreen="\033[1;32m"  			# Green
EBYellow="\033[1;33m" 			# Yellow
EBBlue="\033[1;34m"   			# Blue
EBPurple="\033[0;35m" 			# Purple
EBCyan="\033[1;36m"   			# Cyan
EBWhite="\033[1;37m"  			# White

# High Intensty
EIYellow="\033[0;93m"       # Yellow
