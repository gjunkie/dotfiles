...
_G.packer_plugins = {
  ...
  ["emmet-vim"] = {
    config = { "\27LJ\2\nê\1\0\0\3\0\3\0\0056\0\0\0009\0\1\0'\2\2\0B\0\2\1K\0\1\0qlet g:user_emmet_settings = webapi#json#decode(join(readfile(expand('~/.config/nvim/snippets.json')), \"\\n\"))\bcmd\bvim\0" },
    loaded = true,
